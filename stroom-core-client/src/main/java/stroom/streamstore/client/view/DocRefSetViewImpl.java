...
import stroom.streamstore.client.presenter.DocRefSetUiHandlers;
import stroom.svg.client.SvgPresets;
import stroom.widget.button.client.SvgButton;

public class DocRefSetViewImpl extends ViewWithUiHandlers<DocRefSetUiHandlers> implements DocRefSetView {
    ...
    @Inject
    public DocRefSetViewImpl(final Binder binder) {
    ...
    public interface Binder extends UiBinder<Widget, DocRefSetViewImpl> {
    }
}
